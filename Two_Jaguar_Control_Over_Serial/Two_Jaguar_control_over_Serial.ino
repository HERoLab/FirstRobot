/*
  ==========PROTOCOL:==========
    ...
    To control LEFT Jaguar, send decimal values in range 75-129 (hex 0x4B-0x81)
        ===NOTE THAT THESE ARE DECIMAL VALUES, NOT NUMERICAL ASCII CHARACTERS===
  */
...
void loop(){
  ...
  {
    do: {
      temp = serial.read(); //get a byte
      if (temp == 0) {  //If temp is an EMERGENCY STOP REQUEST
